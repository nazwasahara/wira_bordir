    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="mt-14 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="bg-white/90 p-10 rounded-xl shadow-md">
                ...
                <div class="mt-10 space-y-6 text-text-dark text-md">

                    <!-- Alamat -->
                    <p class="flex items-center gap-6">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="#344E41" viewBox="0 0 100 100" width="30" height="30">
                    ...
                    <p class="flex items-center gap-6">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none">
                            <path d="M12 7V12L9.5 13.5M21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12Z" stroke="#344E41" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                        </svg>
