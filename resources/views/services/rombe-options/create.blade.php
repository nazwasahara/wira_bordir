...
@section('title', 'Tambah Opsi Rombe Baru')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2 class="mb-0"><i class="fas fa-gem me-2"></i>Tambah Opsi Rombe Baru</h2>
...
<div class="row">
    <div class="col-lg-8">
        <form action="{{ route('services.rombe-options.store') }}" method="POST" id="rombeOptionForm">
            @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="alert alert-info d-flex align-items-center" role="alert">
                                ...
                                <div>
                                    <small><strong>Tips:</strong> Rombe adalah hiasan berbentuk diamond/berlian. Ukuran lebih besar biasanya lebih mahal dan lebih mencolok.</small>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save me-2"></i>Simpan Opsi Rombe
                        </button>
    ...
    <div class="col-lg-4">
        <div class="card border-0 shadow-sm sticky-top" style="top: 20px;">
            ...
            <div class="card-body">
                <h6 class="fw-bold">Tips Menambah Opsi Rombe:</h6>
                <ul class="small">
                    <li class="mb-2">Kombinasi warna dan ukuran harus unik</li>
                    <li class="mb-2">Rombe kecil untuk aksen halus</li>
                    <li class="mb-2">Rombe sedang untuk dekorasi standar</li>
                    <li class="mb-2">Rombe besar untuk tampilan mewah</li>
                </ul>
            </div>
        </div>
    </div>
...
// Auto price suggestion based on size
...
sizeSelect?.addEventListener('change', function() {
    ...
    if (currentPrice == 0 || currentPrice == '') {
        ...
        if (suggestions[this.value]) {
            priceInput.value = suggestions[this.value];
        }
    }
});
</script>
