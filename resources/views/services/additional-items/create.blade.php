...
@section('title', 'Tambah Item Tambahan Baru')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2 class="mb-0"><i class="fas fa-plus-circle me-2"></i>Tambah Item Tambahan Baru</h2>
...
<div class="row">
    <div class="col-lg-8">
        <form action="{{ route('services.additional-items.store') }}" method="POST" id="additionalItemForm">
            @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="alert alert-info d-flex align-items-center" role="alert">
                                ...
                                <div>
                                    <small><strong>Tips:</strong> Setelah membuat item, Anda bisa menambahkan opsi-opsi spesifik (warna, model) dengan harga berbeda di halaman detail.</small>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="col-lg-4">
        <div class="card border-0 shadow-sm sticky-top" style="top: 20px;">
            ...
            <div class="card-body">
                <h6 class="fw-bold">Tips Menambah Item Tambahan:</h6>
                <ul class="small">
                    <li class="mb-2">Item tambahan adalah aksesori pelengkap sash</li>
                    <li class="mb-2">Setiap item bisa punya banyak opsi (warna, model)</li>
                    <li class="mb-2">Harga dasar bisa 0 jika harga tergantung opsi</li>
                    <li class="mb-2">Tambahkan opsi setelah item dibuat</li>
                </ul>
            </div>
        </div>
    </div>
